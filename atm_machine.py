...
class AtmMachineApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.frames = {}
        for F in (StartPage, InputPasswordPage, MenuPage, WithdrawPage, DepositPage, BalancePage):
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        password_label = tk.Label(self,
                                                      text='Enter your PIN number \n 당신의 에제 PIN 넘버는 123-456-789 입니다.',
                                                      font=('orbitron',13),
                                                      bg='#3d3d5c',
                                                      fg='white')
        ...
        def check_password():
            # 비밀번호 설정
           if my_password.get() == '123-456-789':
               my_password.set('')
               incorrect_password_label['text']=''
               controller.show_frame('InputPasswordPage')
           else:
...
class InputPasswordPage(tk.Frame):
